...
void shci_user_evt_task ( void* vp_arg )
{
  for ( ; ; )
  {
...
static void APPE_SysUserEvtRx(void * pPayload)
{
  ...
  case SHCI_SUB_EVT_CODE_READY:
    ...
    printf(">>== SHCI_SUB_EVT_CODE_READY\n\r");
    APPE_SysEvtReadyProcessing(pPayload);
    break;

  case SHCI_SUB_EVT_ERROR_NOTIF:
    printf(">>== SHCI_SUB_EVT_ERROR_NOTIF \n\r");
    APPE_SysEvtError(pPayload);
    break;

  case SHCI_SUB_EVT_BLE_NVM_RAM_UPDATE:
    printf(">>== SHCI_SUB_EVT_BLE_NVM_RAM_UPDATE -- BLE NVM RAM HAS BEEN UPDATED BY CPU2 \n");
    printf("     - StartAddress = %lx , Size = %ld\n",
