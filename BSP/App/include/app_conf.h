 ...
 */
#define CFG_ADV_BD_ADDRESS                (0x47504150b1e0)
 ...
 */
#define CFG_GAP_DEVICE_NAME             "RTS_RLS01"
 ...
 * This parameter is ignored by the CPU2 when CFG_BLE_OPTIONS has SHCI_C2_BLE_INIT_OPTIONS_LL_ONLY flag set
 */
#define CFG_BLE_ATT_VALUE_ARRAY_SIZE    (1344 + 1000)
...
#define CFG_BLE_RX_MODEL_CONFIG         (SHCI_C2_BLE_INIT_RX_MODEL_AGC_RSSI_BLOCKER)
